...
export default function HomePage() {
  ...
  return (
    <div className="relative w-full min-h-screen bg-black">
      ...
      <section className="py-16 bg-gray-100 z-20 relative">
        <div className="w-full max-w-5xl mx-auto rounded-lg overflow-hidden shadow-lg border h-[32rem] bg-white">
          <MapView hideToolbarAndMenu defaultViewMode="heat" />
        </div>
      </section>
      {/* Footer */}
