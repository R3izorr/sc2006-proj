...
export default function AdminPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#232946] to-[#6c63ff] flex flex-col items-center py-16">
      <div className="w-full max-w-7xl bg-white rounded-3xl shadow-2xl p-12 md:p-24 flex flex-col gap-14">
        <div className="flex items-center justify-between mb-10">
          <h1 className="text-4xl font-bold text-violet-700">Admin Console</h1>
          <a
            href="#/map"
            className="px-6 py-3 rounded-lg border border-violet-600 text-violet-700 font-semibold hover:bg-violet-50 transition text-lg"
          >
            View Map
          </a>
        </div>
